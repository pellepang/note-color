...
class MenuDisplay:
    ...
    def move(self, delta):
        ...
        self.selected = (self.selected + delta) % len(TOOLS)
    ...
    def render(self, status=""):
        ...
        hint = "Up/Down or 1-{}=select  Enter=go  Ctrl+C=quit".format(len(TOOLS))
        hint_row = top + 2 + len(TOOLS) + 1
