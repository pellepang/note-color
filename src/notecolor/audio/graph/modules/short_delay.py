...
class ShortDelay(Module):
    ...
    def process(self, ctx):
        ...
        while start < n:
            ...
            self._chunk(source, out, start, stop, delay, feedback, mix)
            start = stop

    def _chunk(self, source, out, start, stop, delay, feedback, mix):
        count = stop - start
        ...
        self._copy_in(source[start:stop], feedback, count)
    ...
    def _copy_in(self, dry, feedback, count):
        write = self._write
