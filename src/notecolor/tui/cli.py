...
from notecolor.tui.app import (SessionState, _positive_float, _parse_time_signature, run_batch_transcribe, run_replay_session,
                   run_score_editor, run_session, run_synth_tool)
from notecolor.tui.shell import run_menu_loop
...
def main(argv=None):
    ...
    if args.view == "convert":
        from notecolor.tui.app import run_convert
