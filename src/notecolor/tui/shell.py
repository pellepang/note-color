...
from notecolor.tui.app import RawKeys, run_score_editor, run_session, run_synth_tool
from notecolor.tui.menu_display import MenuDisplay, MENU_ITEMS
from notecolor.tui.settings_display import run_settings_screen
from notecolor.tui.credits_display import run_credits_screen
from notecolor.tui.prototypes_display import run_prototypes_screen
from notecolor.tui.stats_display import run_stats_screen
...
def run_menu_loop(session, fps=None, perf_mode_override=None):
    ...
    while True:
        ...
        if selection == "edit":
            ...
            from notecolor.tui.score_editor_picker import run_score_editor_picker
