...
def credits_lines():
    ...
    lines = [
        ...
        f"please support on {config.DONATION_PLATFORM}: {config.DONATION_URL}",
        "",
...
def _render(donation_link_text):
    ...
    for i, line in enumerate(lines):
        if line.startswith("please support on"):
            line = donation_link_text
